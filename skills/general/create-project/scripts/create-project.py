...
This script is deprecated. Use the new improved script:
    python 00-system/skills/create-project/scripts/init_project.py "Project Name" --path 03-projects
...
print("  python 00-system/skills/create-project/scripts/init_project.py \"Project Name\" --path 03-projects")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Create a new Beam Next project")
