...
Ask these FIRST to understand the project:
...
1. **Build Topic** - What the project is about
...
You are exploring the codebase to inform a PROJECT for: "{build_topic}"
...
**Impact Assessment**:
{how the project might affect this area}
...
**Scan 03-projects/ for similar work:**

```python
def check_related_builds(project_name, build_intent):
    """Find builds with similar names or purposes."""

    builds_dir = Path("03-projects/active")
    related = []

    # Extract keywords from build name and intent
    keywords = extract_keywords(project_name + " " + build_intent)
...
**Action**: Consider if this project should merge with or depend on existing work.
```

### Step 5: Related Skills Check

**Scan 01-skills/ and 00-system/skills/ for reusable skills:**
...
| "Build 02-auth-refactor is also modifying auth files" | "Should this project wait for 02-auth-refactor to complete, or proceed independently?" |
...
*Reference for plan-project Phase 2 Active Research*
