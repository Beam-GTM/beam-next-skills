...
| **skill** | Creating Beam Next skills and capabilities | Skill: create-skill |
...
**Description**: Connecting external APIs and services to Beam Next
...
**Description**: Creating new Beam Next skills and automation capabilities
...
2. **Phase 2b: Active Research** - AI explores based on answers
   ...
   - [ ] Related builds checked in 03-projects/
   - [ ] Related skills checked in 01-skills/ and 00-system/skills/
   - [ ] Integration configs checked in 02-memory/integrations/
