...
- Scan `03-projects/active/` and `03-projects/complete/` for similar names/purposes
...
- Query `02-memory/integrations/` for relevant integrations
- Check if existing integrations provide context for this project
...
### scripts/
- **init_project.py**: Build template generator with `--type` flag
  - Usage: `beam-next-init-project "Name" --type build --path 03-projects/active`
