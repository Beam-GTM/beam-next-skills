...
if not BEAM_NEXT_ROOT:
    print("[ERROR] Error: Could not find Beam Next root")
    sys.exit(1)

TEMPLATES_DIR = os.path.join(BEAM_NEXT_ROOT, '00-system', 'skills', 'skill-dev', 'create-master-skill', 'templates')
...
Examples:
    ...
    parser.add_argument('--path', default=os.path.join(BEAM_NEXT_ROOT, '00-system', 'skills'),
    ...
    if not os.path.isabs(args.path):
        args.path = os.path.join(BEAM_NEXT_ROOT, args.path)
