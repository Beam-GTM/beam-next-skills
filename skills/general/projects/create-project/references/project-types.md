...
- [ ] **Check for related projects** in 03-projects/
- [ ] **Identify related skills** in 01-skills/
...
AI: [Scans codebase]
    Found:
    - 01-skills/lead-qualification/SKILL.md
    ...
    **Files Impacted**:
    - `01-skills/lead-qualification/SKILL.md` - Main workflow logic
