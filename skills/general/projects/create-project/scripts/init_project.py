#!/usr/bin/env python3
"""
Project Initializer - Creates a new Beam Next project from template
...
def main():
    if len(sys.argv) < 4 or sys.argv[2] != '--path':
        ...
        print("\nPath:")
        print("  - Should point to your 03-projects/ directory")
        ...
        print("\nExamples:")
        print('  init_project.py "Website Redesign" --path 03-projects --type build')
        print('  init_project.py "Market Research" --path 03-projects --type research')
        print('  init_project.py "Q1 Strategy" --path 03-projects --type strategy')
        print("\nProject structure created:")
        print("  03-projects/")
