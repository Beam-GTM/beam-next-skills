...
def main():
    ...
    parser.add_argument('--build', required=True,
                       help='Project ID (e.g., 24-build-skills-research)')
    ...
    # Check active projects first, then complete, then root (legacy)
    search_paths = [
        cwd / "03-projects" / "active" / args.build,
        cwd / "03-projects" / "archive" / args.build,
        cwd / "03-projects" / args.build,  # Legacy
        cwd.parent / "03-projects" / "active" / args.build,
        cwd.parent / "03-projects" / "archive" / args.build,
        cwd.parent / "03-projects" / args.build,  # Legacy
    ]
    ...
    for path in search_paths:
        ...
        for subdir in ["active", "archive", ""]:
            fallback_path = project_root / "03-projects" / subdir / args.build if subdir else project_root / "03-projects" / args.build
    ...
    if not project_path or not project_path.exists():
        ...
        logging.error(f"Searched in: 03-projects/active/, 03-projects/complete/, 03-projects/")
        sys.exit(1)
