...
USER_SKILLS_DIR = PROJECT_ROOT / "01-skills"  # Default: user integrations
...
def create_connect_skill(config: dict, output_dir: Path, skills_base_path: str):
    ...
    Args:
        ...
        skills_base_path: Base path for scripts (e.g., "01-skills" or "00-system/skills/integrations")
    """
...
def scaffold_integration(config: dict, system_integration: bool = False):
    ...
    Args:
        ...
        system_integration: If True, create in 00-system/skills/integrations/ (internal dev only)
                           If False (default), create in 01-skills/ (user integrations)
    """
    base_dir = SYSTEM_INTEGRATIONS_DIR if system_integration else USER_SKILLS_DIR
    skills_base_path = "00-system/skills/integrations" if system_integration else "01-skills"
...
def main():
    ...
    parser.add_argument(
        "--system",
        action="store_true",
        help="Create in 00-system/skills/integrations/ (internal dev only). Default: 01-skills/"
    )
