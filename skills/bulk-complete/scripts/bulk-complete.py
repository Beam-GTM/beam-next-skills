...
def bulk_complete_tasks(
    ...
    possible_folders = [
        base / "03-projects" / project_id,  # Full ID provided
        base / "03-projects" / f"{project_id.zfill(2)}-*",  # Just number provided
        base / "03-projects" / "00-onboarding" / project_id,  # Onboarding subfolder
        base / "03-projects" / "00-onboarding" / f"{project_id.zfill(2)}-*",  # Onboarding with number
    ]
    ...
    if not project_path or not project_path.exists():
        ...
        print(f"[INFO] Searched in: 03-projects/")
        return False
