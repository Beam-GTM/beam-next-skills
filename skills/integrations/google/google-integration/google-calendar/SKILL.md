...
```python
import sys
sys.path.insert(0, "01-skills/google-calendar/scripts")
...
3. Add to `.env` file at Beam Next root:
   ```
...
- **Tokens stored locally** - In `02-memory/integrations/google-token.json`
