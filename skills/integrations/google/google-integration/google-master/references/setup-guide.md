...
3. Name it (e.g., "Beam Next Integration")
4. Click **Create**
...
Add these lines to your `.env` file (at Beam Next root):
...
4. Save the token to `02-memory/integrations/google-token.json`
...
- Already in `.gitignore` (inside `02-memory/`)

### Revoking Access

To revoke Beam Next's access to your Google account:
1. Go to [Google Account Security](https://myaccount.google.com/security)
2. Third-party apps with account access
3. Find "Beam Next" and click **Remove Access**
...
| Access token | `02-memory/integrations/google-token.json` | Your authenticated session |
