...
Complete guide for setting up Slack integration with Beam Next.
...
```bash
# If skill is in 01-skills/slack/:
python 01-skills/slack/slack-master/scripts/setup_slack.py
...
```bash
# If skill is in 01-skills/slack/:
python 01-skills/slack/slack-master/scripts/check_slack_config.py
...
**Fix**:
1. Ask a workspace admin to install the Beam Next Integration app
...
To revoke Beam Next's access to your Slack:
1. Go to your Slack workspace
2. Click your profile → **Settings & administration** → **Manage apps**
3. Find "Beam Next Integration" and remove it
