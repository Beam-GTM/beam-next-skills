...
This guide walks you through setting up the HubSpot integration with Beam Next using a Private App access token.
...
- **Name**: `Beam Next Integration`
- **Description**: `Integration for Beam Next workspace automation`
