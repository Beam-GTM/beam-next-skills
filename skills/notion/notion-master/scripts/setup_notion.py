...
def get_api_key():
    ...
    print("    → Name: 'Beam Next' (or your preferred name)")
...
def get_database_id():
    ...
    print("-" * 60)
    print()
    print("For Beam Beam Next Skills database, use:")
...
def main():
    ...
    print(f"  • 02-memory/integrations/notion-databases.yaml → Database context")
    print()
    print("You can now use:")
    print("  • query-notion-db")
    print("  • import-skill-to-beam-next")
