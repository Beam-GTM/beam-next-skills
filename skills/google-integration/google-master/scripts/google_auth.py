...
Token stored in: 02-memory/integrations/google-token.json
...
# Find Beam Next root (look for CLAUDE.md)
...
TOKEN_PATH = BEAM_NEXT_ROOT / "02-memory" / "integrations" / "google-token.json"
CREDENTIALS_PATH = BEAM_NEXT_ROOT / "google-credentials.json"
...
def get_credentials_config():
    ...
    project_id = os.environ.get('GOOGLE_PROJECT_ID', 'beam next')
...
def status():
    ...
    print("=" * 60)
    print()
    print(f"Beam Next Root: {BEAM_NEXT_ROOT}")
    print()
    print("FILES:")
