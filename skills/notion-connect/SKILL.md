...
2. If exit code 2 (not configured), run the interactive setup wizard:
   ...
   - Create `02-memory/integrations/notion-databases.yaml`
...
**Steps**:
1. Run config check (Workflow 0)
2. Load context: Read `02-memory/integrations/notion-databases.yaml`
...
4. Optionally save to `02-memory/integrations/notion-users.yaml`
