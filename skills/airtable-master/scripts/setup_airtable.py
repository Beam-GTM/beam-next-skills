...
5. Saving context to 02-memory/integrations/
"""
...
def find_beam_next_root():
    """Find Beam Next root directory by looking for CLAUDE.md"""
...
def get_api_key_interactive():
    ...
    print("  3. Name it 'Beam Next Integration'")
    print("  4. Add scopes:")
    ...
    if discover_script.exists():
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                integrations_dir = root / '02-memory' / 'integrations'
...
def main():
    ...
    print(f"  * 02-memory/integrations/airtable-bases.yaml -> Base context")
    print()
