...
**CRITICAL**: Load 02-memory/goals.md FIRST before asking any questions.

```markdown
Loading your goals and work context...
```

Read `02-memory/goals.md` and extract:
- Role / Primary Focus
...
Load `03-projects/project-map.md` and update the "Current Focus" section:
...
Write updated `03-projects/project-map.md`.
...
- Or just start working—Beam Next will guide you!
...
- [ ] Update 03-projects/project-map.md
...
- Suggest ID based on existing projects in 03-projects/project-map.md
...
- [ ] Name is unique (check against 03-projects/project-map.md)
...
Load `03-projects/project-map.md` and update:
...
2. Return later: Load Beam Next and say "continue working" or "work on {project-name}"
...
```bash
python 00-system/core/beam-next-loader.py --skill close-session
```
