...
**Load Command**: `beam-next-load --skill add-integration`
...
| File | Purpose |
|------|---------|
| `01-skills/{{service_slug}}/{{service_slug}}-master/SKILL.md` | Shared resources |
| `01-skills/{{service_slug}}/{{service_slug}}-connect/SKILL.md` | Connection setup |
| `01-skills/{{service_slug}}/{{service_slug}}-{{operation}}/SKILL.md` | Per-endpoint skill |
