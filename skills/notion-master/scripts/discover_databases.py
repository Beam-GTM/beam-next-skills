...
Returns:
    ...
    Creates/updates: 02-memory/integrations/notion-databases.yaml
"""
...
def save_context_file(databases, root_path):
    ...
    Args:
        ...
        root_path: Beam Next root path

    Returns:
        Path to saved file or None on error
    """
    integrations_dir = root_path / "02-memory" / "integrations"
...
def main():
    ...
    context_file = root / "02-memory" / "integrations" / "notion-databases.yaml"
