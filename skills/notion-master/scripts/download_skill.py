...
Examples:
    ...
    python download_skill.py abc123-page-id --output-dir 01-skills
...
def backup_existing_skill(skill_path, backup_dir):
    ...
    Args:
        ...
        backup_dir: Directory for backups (e.g., 01-skills/.backup/)
...
def extract_json_bundle(content, output_dir, backup_dir=None):
    ...
    if bundle.get("bundle_format") != "beam-next-skill-bundle-v1":
...
Example:
  ...
  python download_skill.py abc123-page-id --no-backup
    ...
    parser.add_argument("--output-dir", help="Output directory for skill folder (default: 01-skills)")
