...
Examples:
    python upload_skill.py 01-skills/my-skill --team General
    python upload_skill.py 01-skills/beam-agents --team Solutions --integration "Beam AI"
    python upload_skill.py 01-skills/my-skill --team General --dry-run
    python upload_skill.py 01-skills/my-skill --team General --as-new "my-skill-enhanced"
...
Example:
  python upload_skill.py 01-skills/my-skill --team General
  python upload_skill.py 01-skills/beam-agents --team Solutions --integration "Beam AI,Linear"
  python upload_skill.py 01-skills/my-skill --team General --dry-run
  python upload_skill.py 01-skills/my-skill --team General --as-new "my-skill-enhanced"
        """
    )
    ...
    # Find Beam Next root and load config
    root = find_beam_next_root()
    env_path = root / '.env'
    env_vars = load_env_file(env_path)

    config_path = root / '02-memory' / 'user-config.yaml'
