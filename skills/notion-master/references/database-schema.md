# Beam Beam Next Skills Database Schema

Complete schema documentation for the "Beam Beam Next Skills" Notion database.
...
**Database URL**: [Beam Beam Next Skills](https://notion.so/2bc2cadf-bbbc-80be-af8a-d45dfc8dfa2e)
