...
Comprehensive guide to the newly created format-and-lint-code Beam Next skill.

## Overview

You now have a complete, production-ready Beam Next skill for formatting and linting code before commits. The skill supports 9 languages and integrates with popular formatters and linters.
...
- Beam Next Orchestrator: See 00-system/core/orchestrator.md
...
You now have a **complete, production-ready Beam Next skill** for formatting and linting code. The skill:
...
- [OK] Follows Beam Next skill conventions
