# Beam Next Skills Library — Overview

Skills directory with **Skill**, **Owner**, **Version**, and **Category**.

To regenerate after adding/updating skills:
```bash
python3 build_registry.py .
python3 build_readme_overview.py --registry registry.yaml --markdown > OVERVIEW.md
```
