...
Installable skills for [Beam Next](https://github.com/Beam-GTM/beam-next-raw). **148 skills** across integrations, general workflows, learning, and more.
...
| project-cleanup | 4.0 | system |
| project-restructure | 1.0 | system |
